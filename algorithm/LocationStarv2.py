...
def LocationStarv2(B, d):
    ...
    Gx1 = np.array([(-(-B[0, 1] - B[4, 1] + B[3, 1] + B[7, 1]) -
                     (B[0, 2] - B[4, 2] + B[3, 2] - B[7, 2])),
                    (-B[0, 0] - B[4, 0] + B[3, 0] + B[7, 0]),
                    (B[0, 0] - B[4, 0] + B[3, 0] - B[7, 0]),
                    (-B[0, 0] - B[4, 0] + B[3, 0] + B[7, 0]),
                    (-B[0, 1] - B[4, 1] + B[3, 1] + B[7, 1]),
                    (B[0, 1] - B[4, 1] + B[3, 1] - B[7, 1]),
                    (B[0, 0] - B[4, 0] + B[3, 0] - B[7, 0]),
                    (-B[0, 2] - B[4, 2] + B[3, 2] + B[7, 2]),
                    (B[0, 2] - B[4, 2] + B[3, 2] - B[7, 2])]) / 2 / d
    Gx1 = Gx1.reshape(3, 3)

    Gx2 = np.array([(-(-B[1, 1] - B[5, 1] + B[2, 1] + B[6, 1]) -
                     (B[1, 2] - B[5, 2] + B[2, 2] - B[6, 2])),
                    (-B[1, 0] - B[5, 0] + B[2, 0] + B[6, 0]),
                    (B[1, 0] - B[5, 0] + B[2, 0] - B[6, 0]),
                    (-B[1, 0] - B[5, 0] + B[2, 0] + B[6, 0]),
                    (-B[1, 1] - B[5, 1] + B[2, 1] + B[6, 1]),
                    (B[1, 1] - B[5, 1] + B[2, 1] - B[6, 1]),
                    (B[1, 0] - B[5, 0] + B[2, 0] - B[6, 0]),
                    (-B[1, 2] - B[5, 2] + B[2, 2] + B[6, 2]),
                    (B[1, 2] - B[5, 2] + B[2, 2] - B[6, 2])]) / 2 / d
    Gx2 = Gx2.reshape(3, 3)

    Gy1 = np.array([(B[3, 0] + B[7, 0] - B[2, 0] - B[6, 0]),
                    (B[3, 1] + B[7, 1] - B[2, 1] - B[6, 1]),
                    (B[3, 0] - B[7, 0] + B[2, 0] - B[6, 0]),
                    (B[3, 1] + B[7, 1] - B[2, 1] - B[6, 1]),
                    (-(B[3, 0] + B[7, 0] - B[2, 0] - B[6, 0]) -
                     (B[3, 2] - B[7, 2] + B[2, 2] - B[6, 2])),
                    (B[3, 1] - B[7, 1] + B[2, 1] - B[6, 1]),
                    (B[3, 2] + B[7, 2] - B[2, 2] - B[6, 2]),
                    (B[3, 1] - B[7, 1] + B[2, 1] - B[6, 1]),
                    (B[3, 2] - B[7, 2] + B[2, 2] - B[6, 2])]) / 2 / d
    Gy1 = Gy1.reshape(3, 3)

    Gy2 = np.array([(B[0, 0] + B[4, 0] - B[1, 0] - B[5, 0]),
                    (B[0, 1] + B[4, 1] - B[1, 1] - B[5, 1]),
                    (B[0, 0] - B[4, 0] + B[1, 0] - B[5, 0]),
                    (B[0, 1] + B[4, 1] - B[1, 1] - B[5, 1]),
                    (-(B[0, 0] + B[4, 0] - B[1, 0] - B[5, 0]) -
                     (B[0, 2] - B[4, 2] + B[1, 2] - B[5, 2])),
                    (B[0, 1] - B[4, 1] + B[1, 1] - B[5, 1]),
                    (B[0, 2] + B[4, 2] - B[1, 2] - B[5, 2]),
                    (B[0, 1] - B[4, 1] + B[1, 1] - B[5, 1]),
                    (B[0, 2] - B[4, 2] + B[1, 2] - B[5, 2])]) / 2 / d
    Gy2 = Gy2.reshape(3, 3)

    Gz1 = np.array([(B[0, 0] - B[1, 0] + B[3, 0] - B[2, 0]),
                    (-B[0, 0] - B[1, 0] + B[3, 0] + B[2, 0]),
                    (B[0, 2] - B[1, 2] + B[3, 2] - B[2, 2]),
                    (B[0, 1] - B[1, 1] + B[3, 1] - B[2, 1]),
                    (-B[0, 1] - B[1, 1] + B[3, 1] + B[2, 1]),
                    (-B[0, 2] - B[1, 2] + B[3, 2] + B[2, 2]),
                    (B[0, 2] - B[1, 2] + B[3, 2] - B[2, 2]),
                    (-B[0, 2] - B[1, 2] + B[3, 2] + B[2, 2]),
                    (-(B[0, 0] - B[1, 0] + B[3, 0] - B[2, 0]) -
                     (-B[0, 1] - B[1, 1] + B[3, 1] + B[2, 1]))]) / 2 / d
    Gz1 = Gz1.reshape(3, 3)

    Gz2 = np.array([(B[4, 0] - B[5, 0] + B[7, 0] - B[6, 0]),
                    (-B[4, 0] - B[5, 0] + B[7, 0] + B[6, 0]),
                    (B[4, 2] - B[5, 2] + B[7, 2] - B[6, 2]),
                    (B[4, 1] - B[5, 1] + B[7, 1] - B[6, 1]),
                    (-B[4, 1] - B[5, 1] + B[7, 1] + B[6, 1]),
                    (-B[4, 2] - B[5, 2] + B[7, 2] + B[6, 2]),
                    (B[4, 2] - B[5, 2] + B[7, 2] - B[6, 2]),
                    (-B[4, 2] - B[5, 2] + B[7, 2] + B[6, 2]),
                    (-(B[4, 0] - B[5, 0] + B[7, 0] - B[6, 0]) -
                     (-B[4, 1] - B[5, 1] + B[7, 1] + B[6, 1]))]) / 2 / d
    Gz2 = Gz2.reshape(3, 3)
    ...
    dCT_ori = np.array([(CTx1 - CTx2) / d, (CTy1 - CTy2) / d,
                        (CTz1 - CTz2) / d])

    nr_ori = dCT_ori / np.linalg.norm(CT_ori)

    r_estori = abs(
        np.dot(nr_ori, np.array([0, 0, 1])) * d / ((CTz2 / CTz1)**0.25 - 1) -
        np.dot(nr_ori, np.array([0, 0, 1])) * d / 2)
    ...
    for jj in np.arange(6):
        CTtemp[0, jj] = (-lambda_[jj, 1]**2 -
                         np.dot(lambda_[jj, 0], lambda_[jj, 2]))**0.5

    CTnew = np.mean(CTtemp)

    dCTnew = np.array([(CTtemp[0, 0] - CTtemp[0, 1]) / d,
                       (CTtemp[0, 2] - CTtemp[0, 3]) / d,
                       (CTtemp[0, 4] - CTtemp[0, 5]) / d])
    ...
    alpha1 = ((lambda_yin[1] - lambda_yin[0]) /
              (lambda_yin[2] - lambda_yin[0]))**0.5

    alpha2 = ((lambda_yin[2] - lambda_yin[1]) /
              (lambda_yin[2] - lambda_yin[0]))**0.5

    nr2 = np.multiply(alpha1, V[:, 0].T) + np.multiply(alpha2, V[:,
                                                                 2].T)  # 1x3
